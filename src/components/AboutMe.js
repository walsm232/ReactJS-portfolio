        ...
        <div className="container py-5">
            <div className="row">
                ...
                <div className="col-lg-6 col-xm-12">
                    ...
                    <p> 
                        Hello! I am Michael. I have been passionate about technology from a young age, having first started writing code from the age of 13 after attending a CoderDojo class in Waterford, Ireland.
                        <hr/>
